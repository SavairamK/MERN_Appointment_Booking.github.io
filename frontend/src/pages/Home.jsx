      ...
      <section className="hero__section pt-[60px] 2xl:h-[800px]">
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              ...
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus aperiam illo voluptatem consequuntur sint aut in? Laudantium laboriosam recusandae, nobis et alias, minima nostrum consectetur perspiciatis iste inventore consequuntur odit!
                </p>
                <button className="btn">Book my Appointment</button>
              </div>
            ...
            {/* right side hero content starts */}
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                ...
                <div className="w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px] text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 rounded-lg text-irisBlueColor font-[500] mt-2 lg:mt-4">
                  Consultation
                </div>
