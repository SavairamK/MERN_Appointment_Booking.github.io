                        ...
                        <div className="grid md:grid-cols-3 gap-10">
                            <div className="pb-[50px] px-[30px] rounded-md">
                                ...
                                <div className="text-center mt-4">
                                    ...
                                    <p className="text-textColor text-[15px] leading-6 font-medium">
                                        Blood Group :
                                        <span className='ml-2 text-textColor text-[15px] leading-8'>
                                            {userData.bloodType}
                                        </span>
                                    </p>
                                </div>
                            ...
                            <div className="md:col-span-2 md:px-[30px]">
                                {/* booking and profile setting btn starts */}
                                <div className="">
                                    <button
                                ...
                                {/* booking and profile setting btn ends */}


                                {/* routes for booking and profile setting */}
                                {
